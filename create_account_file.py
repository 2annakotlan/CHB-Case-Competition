...
def get_create_account_page():
    ...
    valid_existing_email = email_base in population_df['0_degree'].values and valid_email
    valid_not_existing_email = email_base not in population_df['0_degree'].values and valid_email
