...
from algorithm.py import get_activities
import pandas as pd
...
def get_activities_recommender_page():
    ...
    st.markdown("<h1 style='text-align: center; font-size: 36px; color: #0000FF;'>Activities Recommendation</h1>", unsafe_allow_html=True)
